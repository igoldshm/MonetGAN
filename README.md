...
We implemented a simplified version of the discriminator inspired by the original CycleGAN paper, using 4 convolutional layers, 2 dropout layers, and 2 normalization layers.
### Loss calculation
#### Generator loss
